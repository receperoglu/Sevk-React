...
public class Upload : IHttpHandler
{
    ...
    {
        DataPoint DataCon= new DataPoint();
        ...
        try
        {
            ...
            try
            {
                ...
                SqlCommand sor = new SqlCommand("INSERT INTO Firmalar (Ad,Adres,Nace,Telefon,Fax,Mail,Vergi_No,Vergi_Dairesi,sgk,durum,seviye,il,ilce) VALUES (@Ad,@Adres,@Nace,@Telefon,@Fax,@Mail,@Vergi_No,@Vergi_Dairesi,@sgk,@durum,@seviye,@il,@ilce)", DataCon.baglanti());
