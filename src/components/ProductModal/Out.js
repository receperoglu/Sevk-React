      ...
      <div className="root-345">
        <div className="ms-Dialog-main  main-412">
          ...
          <div className="col-xs-12">
            ...
            />
            {Inputs(OrderList, ChangePiece, ChangeWeight, SaveProductOut)}
          </div>
        </div>
      </div>
    </div>
...
function Inputs(OrderList, ChangePiece, ChangeWeight, SaveProductOut) {
  return OrderList.map((o) => (
    <div key={o.id} className="col-xs-12 padd0 OrderRow">
      <div className="col-xs-6 padd0 padd0 fleft">
        <b> {o.Piece} AD</b> {o.Dimensions} {o.Color} {o.ProductTypeName}
      </div>
